...
export const tools = [
  {
    ...
    image: "https://album-relay.yhay81.com/og.jpg",
  ...
  },
  {
    ...
    image: "https://creator-inbox.yhay81.com/og.jpg",
    imageAlt: "Creator Inboxに絵文字や感想が並ぶ受信箱",
    name: "Creator Inbox",
    slug: "creator-inbox",
    tag: "声を受け取る",
    url: "https://creator-inbox.yhay81.com",
  },
  {
  ...
  },
  {
    ...
    image: "https://peta-sheet.yhay81.com/og.png",
  ...
  },
  {
    ...
    image: "https://mimi-deck.yhay81.com/og.png",
    imageAlt: "Mimi Deckでテーマ検索したエピソードと今度聴くカード",
    name: "Mimi Deck",
    slug: "mimi-deck",
    tag: "聴く回を探す",
    url: "https://mimi-deck.yhay81.com",
  },
  {
    categories: "find organize",
  ...
  },
  {
    ...
    facts: ["登録不要", "進捗は端末内だけ"],
    image: "https://algo-lane.yhay81.com/og.png",
  ...
  },
  {
    ...
    image: "https://dice-seat.yhay81.com/og.png",
    imageAlt: "Dice Seatの円卓、ダイス、空席、候補日時の卓札が並ぶ画面",
    name: "Dice Seat",
    slug: "dice-seat",
    tag: "オンライン卓を募る",
    url: "https://dice-seat.yhay81.com",
  },
  {
    categories: "create share",
  ...
  },
  {
    categories: "find compare",
    description:
      "厚生労働省の職業安定業務統計から、73職種の新規求人数・新規求職申込件数と倍率を、全国・47労働局、3雇用区分、2023〜2025年度で探し、最大4地域で比べる。",
    facts: ["厚生労働省公式統計・31,536組", "73職種・3雇用区分を4地域比較"],
    image: "https://shinki-bairitsu.yhay81.com/og.svg",
    imageAlt:
      "新規求人の箱と新規申込票が左右の搬入口から届き、中央の受付計器で倍率を示す職種新規求人倍率",
    name: "職種新規求人倍率",
    slug: "shinki-bairitsu",
  ...
  },
  {
    categories: "find compare",
    description:
      "厚生労働省の職業安定業務統計から、全国・47労働局の職業計の新規求人倍率を、現行表の2023〜2025年度、3つの常用雇用区分で探し、元件数とともに最大4地域で比べる。",
    facts: ["厚生労働省公式統計・864元値", "48地域・3雇用区分を4地域比較"],
    image: "https://chiiki-shinki-bairitsu.yhay81.com/og.svg",
    imageAlt: "新規求人票と新規求職申込票を受付印で照合し、倍率を記す地域新規求人倍率",
    name: "地域新規求人倍率",
    slug: "chiiki-shinki-bairitsu",
