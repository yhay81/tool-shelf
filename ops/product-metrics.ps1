...
[ordered]@{
    ...
    tools = [ordered]@{
        ...
        choka_to = [int]$Row.choka_to
        tsukue_no_hi = [int]$Row.tsukue_no_hi
        shiori_dana = [int]$Row.shiori_dana
        chord_dai = [int]$Row.chord_dai
        genba_cho = [int]$Row.genba_cho
        iriguchi_cho = [int]$Row.iriguchi_cho
        relay_goyomi = [int]$Row.relay_goyomi
        nakama_fuda = [int]$Row.nakama_fuda
        kan_shigoto = [int]$Row.kan_shigoto
        shutten_fuda = [int]$Row.shutten_fuda
        oyako_madori = [int]$Row.oyako_madori
        deck_watashi = [int]$Row.deck_watashi
        ji_kurabe = [int]$Row.ji_kurabe
        sushiki_hodoki = [int]$Row.sushiki_hodoki
        shiai_ban = [int]$Row.shiai_ban
        ongen_hikae = [int]$Row.ongen_hikae
        atsumari_guchi = [int]$Row.atsumari_guchi
        shisou_to = [int]$Row.shisou_to
        heya_to = [int]$Row.heya_to
        inshi_fuda = [int]$Row.inshi_fuda
        uketsuke_fuda = [int]$Row.uketsuke_fuda
        shunji = [int]$Row.shunji
        hanrei_dana = [int]$Row.hanrei_dana
        yubin_hiki = [int]$Row.yubin_hiki
    }
    rates = [ordered]@{
